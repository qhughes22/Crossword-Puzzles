...
//                    if(rand.nextBoolean()) {
//                        if (checkLocation(p.get2() - x, p.get1(), ChosenWord.direction.DOWN, w)) {
//                            placeWord(w.getLetters(), ChosenWord.direction.DOWN, p.get2() - x, p.get1());
//                            placedWords.add(new ChosenWord(w.getLetters(),w.getClue(),p.get1()-x,p.get2(),3, ChosenWord.direction.DOWN));
//                            return true;
//                        }
//                        if (checkLocation(p.get2(), p.get1() - x, ChosenWord.direction.ACROSS, w)) {
//                            placeWord(w.getLetters(), ChosenWord.direction.DOWN, p.get2(), p.get1() - x);
//                            placedWords.add(new ChosenWord(w.getLetters(),w.getClue(),p.get1(),p.get2()-x,3, ChosenWord.direction.DOWN));
//                            return true;
//                        }
//                    }
//                    else {
...
//                        if (checkLocation(p.get2() - x, p.get1(), ChosenWord.direction.DOWN, w)) {
//                            placeWord(w.getLetters(), ChosenWord.direction.DOWN, p.get2() - x, p.get1());
//                            placedWords.add(new ChosenWord(w.getLetters(),w.getClue(),p.get1()-x,p.get2(),3, ChosenWord.direction.ACROSS));
//                            return true;
//                        }
//                    }
//                }
